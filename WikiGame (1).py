...
def extractLinks(value, pageLinks, depth):
    ...
    for link in value["links"]:
        ...
        if linkTitle.lower() == goalTitle.lower() :
            print("Goal Found!")
            foundGoal = True
            lnksPath[goalTitle] = value["title"]
            break;
        ...
        #https://stackoverflow.com/questions/3389574/check-if-multiple-strings-exist-in-another-string
            ...
            linksVisited.add(linkTitle)
            pageLinks.append([linkTitle, depth + 1])
            lnksPath[linkTitle] = value["title"]
...
def printPath():
    ...
    while currentTitle != startTitle:
        ...
        currentTitle = lnksPath[currentTitle]
...
while userInput != "7":
    ...
    if userInput == "1":
        ...
        print("Edison Chueung - for project planning and documentation.")
        print("Patrick Nguyen - for optimizing the search algorithms.")
